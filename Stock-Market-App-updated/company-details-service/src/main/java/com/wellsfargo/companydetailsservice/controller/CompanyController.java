...
public class CompanyController {
    ...
    // @GetMapping("/companies/se")
    // public List<StockExchange> getAllCompaniesBySeName(@RequestBody String seName) {
    //     return companyService.getAllCompaniesBySeName(seName);
    // }
